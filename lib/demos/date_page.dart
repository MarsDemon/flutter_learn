                              ...
                              onChanged: (value) {
                                if (value) {
                                  setState(() {
                                    ...
                                    inputCheck(isZH ? DateFormat.ZH_MONTH_DAY : _dateFormat);
                                  });
                                }
                              }
                          )
                    ...
                    new Padding(
                      ...
                      child: new Column(
                        children: <Widget>[
                          ...
                          new Checkbox(
                              value: (_dateFormat == DateFormat.MONTH_DAY_HOUR_MINUTE),
                              onChanged: (value) {
                                if (value) {
                                  setState(() {
                                    _dateFormat = DateFormat.MONTH_DAY_HOUR_MINUTE;
                                    inputCheck(isZH ? DateFormat.ZH_MONTH_DAY_HOUR_MINUTE : _dateFormat);
                                  });
                                }
                              })
                        ],
