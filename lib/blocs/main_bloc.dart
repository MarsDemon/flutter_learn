...
class MainBloc implements BlocBase {
  ...
  ///********************* Home **************///
  BehaviorSubject<List<BannerModel>> _banner = BehaviorSubject<
      List<BannerModel>>();
  ...
  BehaviorSubject<List<ReposModel>> _recRepos = BehaviorSubject<
      List<ReposModel>>();
  ...
  /// ******************** Repos *************///
  BehaviorSubject<List<ReposModel>> _repos = BehaviorSubject<
      List<ReposModel>>();
  ...
  /// ******************** Events ****************///
  BehaviorSubject<List<ReposModel>> _events = BehaviorSubject<
      List<ReposModel>>();
